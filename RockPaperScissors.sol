...
contract RockPaperScissors {    
    ...
    event GamePlayed(address player, bool isWinner, string details, uint8 _optionByContract);
    ...
    function playGame(uint8 _optionByPlayer) payable public returns(bool) {
        ...
        if (target[_optionByPlayer] == _optionByContract) {
            ...
            emit GamePlayed(msg.sender, true, details, _optionByContract);
            return true;
            ...
            emit GamePlayed(msg.sender, false, details, _optionByContract);
            return false;
